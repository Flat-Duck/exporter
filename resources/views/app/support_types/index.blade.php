        ...
        <div class="d-flex">
            ...
            <div class="col-auto ms-auto d-print-none">
                ...
                <a
                    ...
                    href="{{ route('support-types.create') }}"
                >
    ...
    <div class="table-responsive">
        <table class="table card-table table-vcenter text-nowrap datatable">
            <thead>
                <tr>
                    <th class="text-left">
                        @lang('crud.support_types.inputs.name')
                    </th>
                ...
                <tr>
                    ...
                    <td class="text-center" style="width: 134px;">
                        <div
                            ...
                            class="btn-group"
                        >
                            @can('update', $supportType)
                            <a
                                href="{{ route('support-types.edit', $supportType) }}"
                                class="btn btn-icon btn-outline-warinig ms-1"
                            >
                                <i class="ti ti-edit"></i>
                            </a>
                            @endcan @can('view', $supportType)
                            <a
                                href="{{ route('support-types.show', $supportType) }}"
                                class="btn btn-icon btn-outline-info ms-1"
                            >
                                <i class="ti ti-eye"></i>
                            </a>
                            @endcan @can('delete', $supportType)
                            <form
                                action="{{ route('support-types.destroy', $supportType) }}"
                                method="POST"
